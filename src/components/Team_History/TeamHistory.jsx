                    ...
                    <section className={styles.timeline}>
                        <div className={`${styles.timelineItem} ${styles.left}`}>
                            ...
                            <div className={styles.timelineContent}>
                                ...
                                <p>
                                    Cardiff Autonomous Racing was founded in October 2024 by Morgan Buke. There had been a
                                    previous iteration of an autonomous racing team at Cardiff in 2017 that disbanded, so we
                                    were determined to revive the team with the view to providing a structure that allows it
                                    to last even as team members graduate.
                                    <br /> <br />
                                    We want to emulate the success of the Cardiff Formula Racing team also based at the
                                    university and believe that this team represents a significant opportunity for students
                                    to develop technical skills and drive innovation.
                                </p>
                            </div>
                            <div className={styles.imgContainer}>
                                <img src={working2} alt="Team working together" />
                            </div>
                        </div>
                        ...
                        <div className={`${styles.timelineItem} ${styles.right}`}>
                            ...
                            <div className={styles.imgContainer}>
                                <img src={recruitment} alt="Recruitment process" />
                            </div>
                        </div>
                        ...
                        <div className={`${styles.timelineItem} ${styles.right}`}>
                            ...
                            <div className={styles.timelineContent}>
                                ...
                                <p>
                                    In July of 2025 we finally found ourselves at Silverstone, competing in our first
                                    competition as a team, and among some great universities. We worked tirelessly at
                                    competition trying to get our system functional on the car. Though we came extremely
                                    close we ultimately ran out of time.
                                    <br />
                                    <br />
                                    Despite this, we left Silverstone having learned much more than we could ever have
                                    expected, and determined to return next year in a strong position to compete now with a
                                    more experienced and knowledgeable team.
                                </p>
                            </div>
                            <div className={styles.imgContainer}>
